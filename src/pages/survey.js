...
const SurveyPage = () => {
  ...
  return (
    <Layout>
      ...
      <h1>主題式音樂AI作曲問卷</h1>
      您好，我們是中研院 音樂與人工智慧實驗室。
      <br />
      首先感謝您願意抽空幫忙填寫問卷！
      <br />
      <br />
      我們目前在研究能夠根據給定的音樂主題來創作曲子的 AI 模型。
      <br />
      <br />
      這份問卷預計需要 15~20
      分鐘，您將會需要幫忙聽一些音樂，並根據指示給予評分。
      <br />
      <br />
      準備好後，請點選下方按鈕來填寫 google 表單，網站將會幫你隨機分配到一個表單
      <br />
      若有任何疑問，歡迎透過 e-mail 與我聯繫 (
      <a href={"mailto:yjshih23@gmail.com"}>yjshih23@gmail.com</a>，施貽仁)。
      <br />
      祝聆聽愉快！
      <br />
      問卷以結束！

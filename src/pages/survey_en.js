...
const SurveyEnPage = () => {
  ...
  return (
    <Layout>
      ...
      Hello!
      <br />
      We are Music and Artificial Intelligence Lab @ Academia Sinica in Taiwan.
      <br />
      First of all, we sincerely appreciate your help with this user study.
      <br />
      <br />
      We are developing AI models that can compose songs given a musical theme
      as condition.
      <br />
      <br />
      This survey may take 15~20 minutes to finish. You will listen to some
      music pieces and evaluate them following our instructions.
      <br />
      <br />
      To start the survey, click the button below and we will randomly assign a
      google form for you.
      <br />
      If you have any problem, feel free to contact me (Ian Shih) via{" "}
      <a href={"mailto:yjshih23@gmail.com"}>yjshih23@gmail.com</a>
      <br />
      Happy listening!
      <br />
